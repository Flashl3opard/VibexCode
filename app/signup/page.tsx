  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center dark:bg-black">
        ...
        {/*  Form */}
        <div className="w-full md:w-1/4 p-10 bg-amber-50 border-0 rounded-xl m-10 dark:bg-zinc-800 dark:text-white">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-4 text-sm text-gray-600  md:flex">
              ...
              <a href="#" className="text-purple-300 m-1">
                Log In
              </a>
              <button className="bg-purple-500 hover:bg-purple-600 text-white px-3 py-1.5 rounded-full">
                Sign Up
              </button>
            </div>
          </div>
