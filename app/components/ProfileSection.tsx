    ...
    <>
      <div className="bg-white dark:bg-zinc-800 rounded-xl shadow p-6 space-y-6 flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          />
          <StatCard icon={Star} label="Rating" value={profile.stats.rating} />
          <StatCard icon={Target} label="Streak" value={profile.stats.streak} />
          <StatCard icon={Award} label="Badges" value={profile.stats.badges} />
        </div>
